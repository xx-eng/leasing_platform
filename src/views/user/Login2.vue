  ...
  <div class="login-container">
    <a-row class="login-main">
      <a-col :span="12" class="login-carousel">
        <img src="@/assets/images/login/mylogo.png">
      </a-col>
      <a-col :span="12" class="login-form-container">
        <div class="title">欢迎登录易起租平台</div>
        ...
        <a-row type="flex" justify="center" style="display: flex; align-items: center; font-size: 13px;position: relative;top: 30px;">
          <a @click="$router.push({path: '/'})">首页</a>
          <a-divider type="vertical"/>
          <a @click="$router.push({path: '/register'})">无账号？去注册</a>
        </a-row>
      </a-col>
    </a-row>
    ...
    <a-row class="foot">
      ...
      <a-row type="flex" justify="center">
        ...
        <a href="javascript:void(0);" target="_blank" style="margin:0 5px;">易起租</a>
        版权所有
      </a-row>
    </a-row>
  </div>
...
.login-container{
  height: 100vh;
  background: url("../../assets/images/login/mylogo.png") no-repeat;
...
/deep/.ant-checkbox .ant-checkbox-input:hover {
  border-color: #127c47;
}
